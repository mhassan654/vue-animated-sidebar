<template>
<nav class="bg-dark border-green-200 px-2 sm:px-4 py-2.5 dark:bg-gray-800">
    <div class="container flex flex-wrap justify-between items-center mx-auto">
        <div class="flex items-center md:order-2">
            ...
            <div class="hidden z-50 my-4 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600" id="dropdown">
                <div class="py-3 px-4">
                    <span class="block text-sm text-gray-900 dark:text-white">Hassan Saava</span>
                    <span class="block text-sm font-medium text-gray-500 truncate dark:text-gray-400">hassansaava@gmail.com</span>
                </div>
